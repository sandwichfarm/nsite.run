...
<section bind:this={sectionElement} class="min-h-screen py-20">
  ...
  "content": ""
      ...
      <div class="bg-gray-800 p-6 rounded-lg
        ...
        <p class="text-gray-300 mb-2">Subdomain style:</p>
        <code class="text-sm bg-gray-700 px-2 py-1 rounded">npub1xxx.example.com</code>
        <p class="text-gray-300 mt-4 mb-2">Path style:</p>
        <code class="text-sm bg-gray-700 px-2 py-1 rounded">example.com/npub1xxx</code>
      </div>
      ...
      <div class="bg-gray-800 p-6 rounded-lg
        ...
        <ul class="text-gray-300 space-y-2">
          ...
          <li>• Blossom (BUD-01)</li>
          <li>• NIP-65 relay lists</li>
